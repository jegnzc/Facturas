...
<body>
  ...
  <section class="factura">
    ...
    <article class="factura__buscar">
      <form class="factura__ingresar" action="#" method="GET">
  ...
  $sql = "INSERT INTO `detalle` (`pkIdDetalle`, `fkIdProducto`, `fkIdFactura`, `cantidad`) 
  VALUES (NULL, $_GET[idfac], $_GET[idprod], $_GET[cantidad])";
